...
export default function Footer() {
  return (
    <footer className="z-100 col-start-1 col-end-3 grid w-full justify-items-center self-start border-t border-neutral-700 border-opacity-25 bg-gradient-to-b from-white to-neutral-200">
